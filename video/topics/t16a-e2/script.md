...
```props
{"eyebrow": "measured", "title": "Reading the memory hierarchy off your own machine", "kind": "line", "series": [{"label": "read+write bandwidth", "color": "#5ac48c", "points": [[16, 41.5], [64, 54.2], [256, 70.9], [1024, 81.1], [4096, 44.6], [16384, 43.2], [65536, 33.8]]}], "xLabel": "working set (KB, log)", "yLabel": "GB/s", "logScale": true, "caption": "In-place scale over arrays of growing size. The cliff between 1 MB and 4 MB is a cache level ending."}
```
