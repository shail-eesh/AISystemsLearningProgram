...
```props
{"eyebrow": "verification", "title": "Two implementations, one trajectory", "kind": "line", "series": [{"label": "your engine", "color": "#5ac48c", "points": [[0, 0.787], [20, 0.352], [40, 0.163], [60, 0.084], [80, 0.048], [100, 0.03], [140, 0.015], [199, 0.0074]]}, {"label": "hand-derived reference", "color": "#7a8aa0", "points": [[0, 0.787], [20, 0.352], [40, 0.163], [60, 0.084], [80, 0.048], [100, 0.03], [140, 0.015], [199, 0.0074]]}], "xLabel": "Adam step", "yLabel": "BCE loss", "caption": "Identical init, identical optimiser, gradients derived two independent ways. Max divergence over 200 steps: 6e-17."}
```
